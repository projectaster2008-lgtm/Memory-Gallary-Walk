...
export const PLAYLIST: SongTrack[] = [
  {
    ...
    themeId: 'blossom',
    themeName: 'Rose-Aurora Flare',
    themeDescription: 'Pink polar flares, peach twilight ribbons, and gentle cosmic blossoms.',
    palette: {
      primary: '#f43f5e',
      secondary: '#fb7185',
      ambientLight: '#ffd1dc',
      ...
      canvasBg: '#09050d',
      particleHue: [330, 350, 160, 180, 280],
    },
  },
  {
    id: 'somewhere',
    ...
    themeName: 'Arctic Emerald Borealis',
    themeDescription: 'Nordic Northern Lights, emerald ion curtains, and cyan celestial mist.',
    palette: {
      primary: '#10b981',
      secondary: '#059669',
      ambientLight: '#a7f3d0',
      ...
      canvasBg: '#040d0f',
      particleHue: [145, 165, 180, 195, 130],
    },
  },
  {
    id: 'true-colors',
    ...
    themeName: 'Celestial Magnetosphere',
    themeDescription: 'High-latitude polar violet, electric cyan ribbons, and prismatic starfields.',
    palette: {
      primary: '#8b5cf6',
      secondary: '#06b6d4',
      ambientLight: '#c4b5fd',
      ...
      canvasBg: '#060515',
      particleHue: [270, 190, 310, 160, 220],
    },
  },
];
